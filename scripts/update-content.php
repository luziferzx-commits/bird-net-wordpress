...
<figure class="wp-block-image size-large"><img src="' . $unsplash['hero'] . '" alt="ผลงานติดตั้งตาข่ายกันนก Birds Go Away" style="border-radius:16px;width:100%;max-width:100%;height:auto;object-fit:contain;"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
</div>
